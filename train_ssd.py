...
parser.add_argument('--datasets', '--data', nargs='+', default=["data/voc_plate_ocr_dataset"], help='Dataset directory path')
...
parser.add_argument('--checkpoint-folder', '--model-dir', default='models/ocr',
